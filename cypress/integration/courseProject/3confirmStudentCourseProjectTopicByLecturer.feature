...
Feature: Course Project
    ...
    Scenario Outline: Confirm student on course project topic
        ...
        And Confirm student on topic "<ProjectName>" on Course project page
        Then I should see assigned student "<Student>" to topic "<ProjectName>" on Course project page
        When Cancel assignment student to topic "<ProjectName>" on Course project page
        Then I should see unassigned student "<Student>" to topic "<ProjectName>" on Course project page
